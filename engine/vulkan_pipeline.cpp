...
VulkanPipeline::VulkanPipeline(const VkDevice deviceIn, const VkFormat formatIn, const VkExtent2D extentIn) : device(deviceIn), swapchainImageFormat(formatIn), swapchainExtent(extentIn){
}
